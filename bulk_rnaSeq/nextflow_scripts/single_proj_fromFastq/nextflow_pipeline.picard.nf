...
process picardRNAmetrics {
    ...
    java -jar /usr/local/bin/picard.jar CollectRnaSeqMetrics \\
      I=${bam} \\
      O=\${outfile} \\
      REF_FLAT=${params.picard_refFlat_human} \\
      STRAND=SECOND_READ_TRANSCRIPTION_STRAND \\
      RIBOSOMAL_INTERVALS=${params.picard_rRNA}
    """
...
process picardMarkDups {
    ...
    outfile=${PICARDDIR}/markdups/bam_out/${bam_pmd}_marked_dups.bam
    metricsfile=${PICARDDIR}/markdups/${bam_pmd}_marked_dup_metrics.txt
